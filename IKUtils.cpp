...
int main() {
    ...
    for(double j = 0; j < 20; j++){
        ...
        // Call the function
        double z = j/100;
        auto thetas = solve_inv_kinematics(0, 0, z);
        ...
        std::cout << "Time taken by solve_inv_kinematics: " << duration.count() << " microseconds\n";
        std::cout << "Theta1: " << thetas[0] << " Theta2: " << thetas[1] << " Theta3: " << thetas[2] << " | Running loss: "<< thetas[3]<< std::endl;
    }
