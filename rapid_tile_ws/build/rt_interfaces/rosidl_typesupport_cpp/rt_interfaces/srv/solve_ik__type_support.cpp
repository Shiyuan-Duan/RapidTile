...
static const _SolveIK_Request_type_support_symbol_names_t _SolveIK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rt_interfaces, srv, SolveIK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rt_interfaces, srv, SolveIK_Request)),
  }
};
...
{
  return &::rt_interfaces::srv::rosidl_typesupport_cpp::SolveIK_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rt_interfaces, srv, SolveIK_Request)() {
  return get_message_type_support_handle<rt_interfaces::srv::SolveIK_Request>();
}
...
static const _SolveIK_Response_type_support_symbol_names_t _SolveIK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rt_interfaces, srv, SolveIK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rt_interfaces, srv, SolveIK_Response)),
  }
};
...
{
  return &::rt_interfaces::srv::rosidl_typesupport_cpp::SolveIK_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rt_interfaces, srv, SolveIK_Response)() {
  return get_message_type_support_handle<rt_interfaces::srv::SolveIK_Response>();
}
...
static const _SolveIK_type_support_symbol_names_t _SolveIK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rt_interfaces, srv, SolveIK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rt_interfaces, srv, SolveIK)),
  }
};
...
{
  return &::rt_interfaces::srv::rosidl_typesupport_cpp::SolveIK_service_type_support_handle;
}
